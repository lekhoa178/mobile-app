import {getLexicon, getNotebook, getResearch, updateResearch} from "./ApiService";
...
export const getAllResearchFromAccount = async (accountId) => {
    ...
    for (let i = 0; i < nbs.length; ++i) {
        ...
        results.push(new Research(nbs[i].id.accountId, new Lexicon(nbs[i].id.lexiconId.synsetId,
